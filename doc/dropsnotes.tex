...
Die ID's der erzeugten Simplexe entsprechen denen in der Datei.
...
Ferner existiert eine GMRES-Implementierung, die zur Zeit nur vom 2D-Code eingesetzt
wird:
\begin{Code}
\begin{verbatim}
template <typename Mat, typename Vec, typename PreCon>
...
darstellen:
\begin{enumerate}
\item $r= BA^{-1}b -c$ berechnen: $r= -c$, $Av = b$ l"osen, $r+= Bv$.
\item $Sp=r$ l"osen.
...
PCG-Verfahren mit SSOR-Vorkonditionierung.
