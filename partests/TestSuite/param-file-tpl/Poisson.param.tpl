...
Refining {
  ...
  dx          = 1.0     # dimension of the brick in x direction  Wird zunächst ignoriert, so dass ich die Lösung kenne!
  dy          = 1.0     # dimension of the brick in y direction  Wird zunächst ignoriert, so dass ich die Lösung kenne!
  dz          = 1.0     # dimension of the brick in z direction  Wird zunächst ignoriert, so dass ich die Lösung kenne!
